...
contract ETHMixup is Mixup {
    constructor(address _verifier, address _hasher, uint256 _denomination, uint32 _merkleTreeHeight) Mixup(IPoseidonHasher(_verifier), IPoseidonHasher(_hasher), _denomination, _merkleTreeHeight) {}
